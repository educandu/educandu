 ...
 * gulp installed globally (for conveninence): npm i -g gulp
 ...
 | ambConfig | Configuration for the AMB endpoint (https://dini-ag-kim.github.io/amb/) | `{ apiKey: <string>, image: <string>, publisher: [{ type: <'Organization'/'Person'>, name: <string> }] }` | no, however if provided, `apiKey` is mandatory |
