export default class Educandu_2024_04_04_01_initial_schema {
  constructor(db) {
    this.db = db;
  }
  ...
  async up() {
    ...
    await createCollectionWithIndexes('documentInputs', [
      {
        name: '_idx_documentId_',
        key: { documentId: 1 }
      },
    ...
    await createCollectionWithIndexes('documentInputMediaItems', [
      {
        name: '_idx_roomId_',
        key: { roomId: 1 }
      },
    ...
    await createCollectionWithIndexes('mediaLibraryItems', [
      {
    ...
    await createCollectionWithIndexes('notifications', [
      {
    ...
    await createCollectionWithIndexes('roomMediaItems', [
      {
        name: '_idx_roomId_',
        key: { roomId: 1 }
      },
