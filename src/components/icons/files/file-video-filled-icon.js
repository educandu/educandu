...
export function FileVideoFilledIconComponent() {
  return (
    <svg height="1em" style={{ enableBackground: 'new 0 0 1000 1000' }} width="1em" viewBox="0 0 1000 1000">
      ...
      <path style={{ display: 'inline', fill: 'currentColor', strokeWidth: '1' }} d="M627.436 602.302 433.094 463.43c-21.22-15.162-50.708 0-50.708 26.089v277.744c0 26.078 29.488 41.25 50.708 26.089L627.436 654.48c17.886-12.793 17.886-39.386 0-52.178z" />
    </svg>
  );
}

function FileVideoFilledIcon(props) {
  return (
    <Icon component={FileVideoFilledIconComponent} {...props} />
  );
}
