...
export function FileTextFilledIconComponent() {
  return (
    <svg height="1em" style={{ enableBackground: 'new 0 0 1000 1000' }} width="1em" viewBox="0 0 1000 1000">
      ...
      <path style={{ fill: 'none', stroke: 'currentColor', strokeWidth: '20', strokeLinecap: 'round', strokeMiterlimit: '10' }} d="M247.87 490.12h504.26M247.87 634.05h504.26M247.87 777.97h407.67M247.87 346.19h204.81" />
    </svg>
  );
}
