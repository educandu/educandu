...
export function CookieAlertIconComponent() {
  return (
    <svg height="1.2em" style={{ enableBackground: 'new 0 0 1000 1000' }} width="1.2em" viewBox="0 0 1000 1000">
      ...
      <circle style={{ fill: 'none', stroke: 'currentColor', strokeWidth: '40', strokeLinecap: 'round', strokeMiterlimit: '10' }} cx="211.14" cy="523.86" r="44.52" />
      <circle style={{ fill: 'none', stroke: 'currentColor', strokeWidth: '40', strokeLinecap: 'round', strokeMiterlimit: '10' }} cx="546.34" cy="508.13" r="49.47" />
      <circle style={{ fill: 'none', stroke: 'currentColor', strokeWidth: '40', strokeLinecap: 'round', strokeMiterlimit: '10' }} cx="651.22" cy="721.14" r="45.33" />
