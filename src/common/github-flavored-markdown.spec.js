    ...
    describe('when called with a mix of portable and accessible CDN URLs', () => {
      it('changes all portable URLs into accessible URLs', () => {
        const result = sut.render([
          '[1. Click here](cdn://document-media/12345/file-1.png)',
          '[2. Click here](cdn://room-media/12345/file-2.png)',
          '[3. Click here](https://cdn.my-domain.com/document-media/12345/file-3.png)',
          '[4. Click here](https://cdn.my-domain.com/room-media/12345/file-4.png)',
          '<cdn://document-media/12345/file-5.png>',
          '<cdn://room-media/12345/file-6.png>',
          '<https://cdn.my-domain.com/document-media/12345/file-7.png>',
          '<https://cdn.my-domain.com/room-media/12345/file-8.png>',
          '![1. Alt text](cdn://document-media/12345/another-file-1.png)',
          '![2. Alt text](cdn://room-media/12345/another-file-2.png)',
          '![3. Alt text](https://cdn.my-domain.com/document-media/12345/another-file-3.png)',
        ...
        expect(result.trim()).toBe([
          '<p><a href="https://cdn.my-domain.com/document-media/12345/file-1.png">1. Click here</a></p>',
          '<p><a href="https://cdn.my-domain.com/room-media/12345/file-2.png">2. Click here</a></p>',
          '<p><a href="https://cdn.my-domain.com/document-media/12345/file-3.png">3. Click here</a></p>',
          '<p><a href="https://cdn.my-domain.com/room-media/12345/file-4.png">4. Click here</a></p>',
          '<p><a href="https://cdn.my-domain.com/document-media/12345/file-5.png">https://cdn.my-domain.com/document-media/12345/file-5.png</a></p>',
          '<p><a href="https://cdn.my-domain.com/room-media/12345/file-6.png">https://cdn.my-domain.com/room-media/12345/file-6.png</a></p>',
          '<p><a href="https://cdn.my-domain.com/document-media/12345/file-7.png">https://cdn.my-domain.com/document-media/12345/file-7.png</a></p>',
          '<p><a href="https://cdn.my-domain.com/room-media/12345/file-8.png">https://cdn.my-domain.com/room-media/12345/file-8.png</a></p>',
          '<p><img src="https://cdn.my-domain.com/document-media/12345/another-file-1.png" alt="1. Alt text"></p>',
          '<p><img src="https://cdn.my-domain.com/room-media/12345/another-file-2.png" alt="2. Alt text"></p>',
          '<p><img src="https://cdn.my-domain.com/document-media/12345/another-file-3.png" alt="3. Alt text"></p>',
    ...
    describe('when called with HTML5 media enabled', () => {
      it('renders videos and audios using HTML5 video and audio tags', () => {
        const result = sut.render([
          ...
          '![](cdn://document-media/12345/file-2.mp3)',
        ...
        expect(result.trim()).toBe([
          ...
          '<p><audio src="https://cdn.my-domain.com/document-media/12345/file-2.mp3" controls></audio></p>',
  ...
  describe('redactCdnResources', () => {
    it('redacts all links and images starting with the cdn protocol only', () => {
      ...
      expect(result).toEqual([
        'This is a [hyperlink](cdn://) and',
        'this is a [hyperlink](cdn://document-media/12345/redacted.png) and',
        'this is too: <cdn://document-media/12345/redacted.png>, and',
        'this is an image: ![](cdn://document-media/12345/redacted.png  ) and',
        'this is an image: ![alt](cdn://document-media/12345/redacted.png  "") and',
        'this is an image: ![alt](cdn://document-media/12345/redacted.png "image title") and',
        'this is a path and not an URL: ![alt](media/12345/example.png "path") and',
  ...
  describe('extractCdnResources', () => {
    it('extracts all links and images starting with the cdn protocol only', () => {
      const result = sut.extractCdnResources([
        '[Click here](cdn://document-media/12345/file-1.png)',
        '[Click here](cdn://room-media/12345/file-2.png)',
        '[Click here](media/12345/file-x.png)',
        '[Click here](room-media/12345/file-x.png)',
        '[Click here](https://cdn.my-domain.com/document-media/12345/file-x.png)',
        '[Click here](https://cdn.my-domain.com/room-media/12345/file-x.png)',
        'Download this: <cdn://document-media/12345/file-3.pdf>',
        'Download this: <cdn://room-media/12345/file-4.pdf>',
        '* Image inside a **bold section ![Alt text](cdn://document-media/12345/file-5.png) within** a list item',
      ...
      expect(result).toEqual([
        'cdn://document-media/12345/file-1.png',
        'cdn://room-media/12345/file-2.png',
        'cdn://document-media/12345/file-3.pdf',
