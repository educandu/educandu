...
class SettingController {
  static get inject() { return [Database, SettingService, DocumentService, MailService, ClientDataMappingService, PageRenderer]; }

  constructor(database, settingService, documentService, mailService, clientDataMappingService, pageRenderer) {
