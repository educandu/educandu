...
describe('amb-service', () => {
  ...
  describe('getDocumentsAmbMetadata', () => {
    ...
    beforeEach(async () => {
      adminUser = await createTestUser(container, { email: 'admin@educandu.dev', displayName: 'Admin', role: ROLE.admin });
      creatorUser = await createTestUser(container, { email: 'creator@educandu.dev', displayName: 'Document Creator', role: ROLE.user });
      contributorUser = await createTestUser(container, { email: 'contributor@educandu.dev', displayName: 'Document Contributor', role: ROLE.user });
    });
