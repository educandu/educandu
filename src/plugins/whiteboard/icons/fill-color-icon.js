...
// SVG is taken and adapted from: https://tabler-icons.io/i/bucket-droplet (MIT licensed - Copyright (c) 2020-2023 Paweł Kuna)

export function FillColorIconComponent() {
  return (
...
function FillColorIcon(props) {
  return (
    <Icon component={FillColorIconComponent} {...props} />
  );
}
