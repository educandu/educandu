...
describe('ear-training-info', () => {
  ...
  describe('getCdnResources', () => {
    ...
    it('returns resources from the sound copyrightNotice', () => {
      const result = sut.getCdnResources({ title: '', tests: [{ sound: { copyrightNotice: '[Hyperlink](cdn://media-library/my-file.pdf)' }, questionImage: {}, answerImage: {} }] });
      expect(result).toStrictEqual(['cdn://media-library/my-file.pdf']);
    });
    it('returns resources from the questionImage copyrightNotice', () => {
      const result = sut.getCdnResources({ title: '', tests: [{ sound: {}, questionImage: { copyrightNotice: '[Hyperlink](cdn://media-library/my-file.pdf)' }, answerImage: {} }] });
      expect(result).toStrictEqual(['cdn://media-library/my-file.pdf']);
    });
    it('returns resources from the answerImage copyrightNotice', () => {
      const result = sut.getCdnResources({ title: '', tests: [{ sound: {}, questionImage: {}, answerImage: { copyrightNotice: '[Hyperlink](cdn://media-library/my-file.pdf)' } }] });
      expect(result).toStrictEqual(['cdn://media-library/my-file.pdf']);
    });
    ...
    it('returns a list with the url for an internal resource', () => {
      const result = sut.getCdnResources({ title: '', tests: [{ sound: { sourceUrl: 'cdn://media-library/some-sound.mp3', copyrightNotice: '' }, questionImage: {}, answerImage: {} }] });
    ...
    it('returns a list with all urls for all internal resources', () => {
      const result = sut.getCdnResources({
        tests: [
          { sound: { sourceUrl: 'cdn://media-library/some-sound-1.mp3', copyrightNotice: '' }, questionImage: {}, answerImage: {} },
          { sound: { sourceUrl: 'https://someplace.com/some-sound-2.mp3', copyrightNotice: '' }, questionImage: {}, answerImage: {} },
          { sound: { sourceUrl: 'cdn://media-library/some-sound-3.mp3', copyrightNotice: '' }, questionImage: {}, answerImage: {} }
        ]
      });
