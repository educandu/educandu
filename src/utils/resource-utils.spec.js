...
describe('resource-utils', () => {
  ...
  describe('getResourceType', () => {
    const testCases = [
      ...
      { url: '.svg', expectedResult: RESOURCE_TYPE.none },
      { url: 'file.unknown', expectedResult: RESOURCE_TYPE.unknown },
      { url: 'file.doc', expectedResult: RESOURCE_TYPE.unknown },
      { url: 'file.rtf', expectedResult: RESOURCE_TYPE.unknown },
      { url: 'file.odt', expectedResult: RESOURCE_TYPE.unknown },
      { url: 'file.txt', expectedResult: RESOURCE_TYPE.unknown },
