...
describe('source-utils', () => {
  describe('getSourceType', () => {
    ...
    const testCases = [
      ...
      { url: 'cdn://media-library/resource.jpeg', expectedResult: SOURCE_TYPE.mediaLibrary },
      { url: 'cdn://room-media/vQHrRHX4X3HSj49Eq4dqyGresource.jpeg', expectedResult: SOURCE_TYPE.roomMedia },
      { url: 'media-library/resource.jpeg', expectedResult: SOURCE_TYPE.mediaLibrary },
      ...
      { url: 'http://cdn-root/media-library/resource.jpeg', expectedResult: SOURCE_TYPE.mediaLibrary },
  ...
  describe('getPortableUrl', () => {
    ...
    const testCases = [
      ...
      { url: 'media-library/resource.jpeg', expectedResult: 'cdn://media-library/resource.jpeg' },
      { url: 'media-library/resource.jpeg', expectedResult: 'cdn://media-library/resource.jpeg' },
  ...
  describe('getAccessibleUrl', () => {
    ...
    const testCases = [
      ...
      { url: 'media-library/resource.jpeg', expectedResult: 'http://cdn-root/media-library/resource.jpeg' },
      { url: 'media-library/resource.jpeg', expectedResult: 'http://cdn-root/media-library/resource.jpeg' },
  ...
  describe('couldAccessUrlFromRoom', () => {
    const testCases = [
      ...
      { url: 'media-library/resource.jpeg', targetRoomId: '22222', expectedResult: true },
      { url: 'cdn://media-library/resource.jpeg', targetRoomId: '22222', expectedResult: true },
      { url: 'media-library/resource.jpeg', targetRoomId: '22222', expectedResult: true },
      { url: 'cdn://media-library/resource.jpeg', targetRoomId: '22222', expectedResult: true },
      ...
      { url: 'media-library/resource.jpeg', targetRoomId: null, expectedResult: true },
      { url: 'media-library/resource.jpeg', targetRoomId: null, expectedResult: true }
    ];
